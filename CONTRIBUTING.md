# Contributing to @mutualzz/ui-web

Thanks for wanting to help with **@mutualzz/ui-web**.

Contributions are welcome. Redistributing unofficial builds or hosting a
competing Mutualzz service is still not allowed — see [`LICENSE`](https://github.com/mutualzz/ui-web/blob/master/LICENSE).
